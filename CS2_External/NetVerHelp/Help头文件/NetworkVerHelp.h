...
#include "../Model/Out_getCalculate.h"
...
#include "../Model/In_getCalculateArgs.h"
...
namespace Help
{
	...
	public:
		...
		//远程算法转化成对象
		static Model::Out_getCalculate ConvertCalculate(string data);
		...
		//获取远程算法
		static Model::Result getCalculate(Model::In_getCalculateArgs dataArgs);
